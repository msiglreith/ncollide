...
/// Time of impacts between two support-mapped shapes under translational movement.
pub fn support_map_against_support_map_with_normal<P, M, G1: ?Sized, G2: ?Sized>(m1: &M, vel1: &P::Vector, g1: &G1,
                                                                     m2: &M, vel2: &P::Vector, g2: &G2)
    ...
    cso.toi_and_normal_with_ray(&Id::new(), &Ray::new(na::origin(), -vel), true)
