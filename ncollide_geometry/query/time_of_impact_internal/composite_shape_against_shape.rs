...
/// Time Of Impact of a composite shape with any other shape, under translational movement.
pub fn composite_shape_against_shape_with_normal<P, M, G1: ?Sized>(m1: &M, vel1: &P::Vector, g1: &G1,
                                                       m2: &M, vel2: &P::Vector, g2: &Shape<P, M>)
...
/// Time Of Impact of any shape with a composite shape, under translational movement.
pub fn shape_against_composite_shape_with_normal<P, M, G2: ?Sized>(m1: &M, vel1: &P::Vector, g1: &Shape<P, M>,
                                                       m2: &M, vel2: &P::Vector, g2: &G2)
                                                       -> Option<(P::Real, P::Vector)>
    where P:  Point,
          P::Vector: Translation<P>,
...
impl<'a, P, M, G1: ?Sized> CompositeShapeAgainstAnyTOINormalCostFn<'a, P, M, G1>
    ...
    pub fn new(m1: &'a M, vel1: &'a P::Vector, g1: &'a G1, m2: &'a M, vel2: &'a P::Vector, g2: &'a Shape<P, M>)
        ...
        CompositeShapeAgainstAnyTOINormalCostFn {
            msum_shift:  -ls_aabb2.center().coordinates(),
            msum_margin: ls_aabb2.half_extents(),
            ray:         Ray::new(na::origin(), m1.inverse_rotate_vector(&(*vel2 - *vel1))),
            m1:          m1,
            vel1:        vel1,
            g1:          g1,
            m2:          m2,
